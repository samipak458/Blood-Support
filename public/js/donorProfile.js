...
onAuthStateChanged(auth, (donor) => {
    ...
    if (donor) {
        ...
        onSnapshot(docRef, (def) => {
            ...
            // Donor Information
            name.innerHTML = "<b>Name: </b>"+ def.data().Name;
            id.innerHTML ="<b>Donor ID: </b>"+ def.data().ID;
            age.innerHTML ="<b>Age: </b>"+ def.data().Age;
            ...
            lastdonate.innerHTML = "<b>Last Donated: </b> Not donated yet";
